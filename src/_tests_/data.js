...
const data = [{
  ...
  second_stage: {
    thrust: { kN: 31, lbf: 7000 }, payloads: { composite_fairing: { height: { meters: 3.5, feet: 11.5 }, diameter: { meters: 1.5, feet: 4.9 } }, option_1: 'composite fairing' }, reusable: false, engines: 1, fuel_amount_tons: 3.38, burn_time_sec: 378,
  },
  engines: {
